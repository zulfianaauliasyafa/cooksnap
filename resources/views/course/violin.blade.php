...
<main>
    ...
    <section>
        <h1>Course 1: Violin Body</h1>
        <img src="images/violin.jpg" alt="Guitar Body">
        <p>1. Body (Badan Violin)<br>
           Body gitar merupakan bagian utama violin yang terbuat dari kayu. Body gitar berfungsi sebagai resonator yang menghasilkan suara dari getaran senar. Bentuk body gitar yang berbeda-beda akan menghasilkan suara yang berbeda pula.<br><br>
           2. Neck (Leher Gitar)<br>
           Neck gitar adalah bagian panjang yang menghubungkan body gitar dengan headstock. Neck gitar terbuat dari kayu dan memiliki fretboard di atasnya.
        </p>
    </section>
</main>
