...
<main>
    ...
    <section>
        <h1>Course 1: Drum Body</h1>
        <img src="images/drum.jpeg" alt="Guitar Body">
        <p>1. Body (Badan Drum)<br>
           Body gitar merupakan bagian utama gitar yang terbuat dari kayu. Body gitar berfungsi sebagai resonator yang menghasilkan suara dari getaran senar. Bentuk body gitar yang berbeda-beda akan menghasilkan suara yang berbeda pula.<br><br>
