...
<div class="container-fluid">
            ...
            <input type="text" name="nama_musik" class="first-input" placeholder = "Buat nama makanan kamu" value="{{ $resep->nama_musik }}">

            <label for="description"></label>
            <h2 class= "judul">Deskripsi</h2>
            <input type="text" name="lirik" class="first-input" id= "desc" placeholder = "Ceritakan tentang makanan yang ingin kamu bagikan " value="{{ $resep->lirik }}">
            ...
            <div class="input-group">
                <input type="text" class= "first-input" name="link" value="{{ $resep->link }}">
                
            </div>

            <h2 class= "judul">Kesulitan</h2>
            <div class="input-group">
            <input type="text" class= "first-input" name="level" value="{{ $resep->level }}" >
                
            </div>

        </div>
            <div class = "serah">
                <button type="submit" class="upload-button">Update</button>
            </div>
            </form>
